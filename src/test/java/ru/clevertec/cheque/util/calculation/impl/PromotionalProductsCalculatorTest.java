...
class PromotionalProductsCalculatorTest {
    ...
    private static Stream<Arguments> args() {
        ...
        return Stream.of(
                Arguments.of(cashReceipts.get(0), 48.665),
                Arguments.of(cashReceipts.get(1), 72.54)
        );
    }

    @BeforeAll
    static void init() {
        calculator = new PromotionalProductsCalculator();
    }
